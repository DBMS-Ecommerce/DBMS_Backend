...
class Item {
    ...
    InitiateItemProperties(product_id, unit_price, image, is_default, quantity) {
        ...
        return new Promise((resolve, reject) => {
                db.query("INSERT INTO item (sku,product_id,unit_price,quantity,is_default,image) VALUES (?,?,?,?,?,?)", [this.sku, product_id, unit_price, quantity, is_default, image], (err, result) => {
